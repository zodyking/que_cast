...
CONF_DUCK_VOLUME = "duck_volume"              # 0.0–1.0 while speaking
CONF_RESTORE_AFTER_MS = "restore_after_ms"    # grace after TTS end

CONF_DETECT_DONE_MODE = "detect_done_mode"    # "state" or "timer"
